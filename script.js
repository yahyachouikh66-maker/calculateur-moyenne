const subjects = [
  { name: "Algèbre",            coeff: 1.0, ds: 0.20, ex: 0.70, orl: 0.10 },
  { name: "ASD",                coeff: 1.5, ds: 0.20, ex: 0.70, orl: 0.10 },
  { name: "Analyse",            coeff: 1.0, ds: 0.20, ex: 0.70, orl: 0.10 },
...
function calculateAll() {
  ...
  document.getElementById('moyenne-generale').innerText = genAverage.toFixed(2);
